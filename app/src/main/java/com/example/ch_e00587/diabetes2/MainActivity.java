...
public class MainActivity extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabSpec tab3=tabHost.newTabSpec("User Profile");
        TabSpec tab4=tabHost.newTabSpec("Userinfo");
        ...
        tab4.setIndicator("");
        tab4.setContent(new Intent(this,Userinfo.class));
        ...
        tab3.setIndicator("",getApplicationContext().getResources().getDrawable(R.drawable.userbutton));
